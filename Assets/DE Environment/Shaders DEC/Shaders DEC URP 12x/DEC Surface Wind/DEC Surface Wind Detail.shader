...
Shader "DEC/Surface Wind/Surface Wind Detail"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Detail_Maskfloat4switch226_g43375( float m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float Detail_BlendVCfloatswitch319_g43375( int m_switch, float m_Red, float m_Green, float m_Blue )
			{
				if(m_switch ==0)
					return m_Red;
				else if(m_switch ==1)
			...
			float3 Detail_Maskfloat3switch221_g43375( float m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
						 ...
						 ) : SV_Target
			{
				...
				float4 temp_output_39_0_g43375 = float4( temp_output_7_0_g38532 , 0.0 );
				float4 Albedo_RGBA40_g43375 = temp_output_39_0_g43375;
				float m_switch226_g43375 = _EnableDetailMask;
				float2 appendResult132_g43375 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43375 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43375 = IN.ase_texcoord7.xy * appendResult132_g43375 + appendResult114_g43375;
				float4 tex2DNode45_g43375 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat, texCoord67_g43375 );
				float4 ALBEDO_OUT255_g43375 = ( _ColorDetail * tex2DNode45_g43375 * _Brightness );
				float4 m_Off226_g43375 = ALBEDO_OUT255_g43375;
				float2 appendResult219_g43375 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43375 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43375 = IN.ase_texcoord7.xy * appendResult219_g43375 + appendResult206_g43375;
				float temp_output_15_0_g43376 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat, texCoord220_g43375 ).r );
				float temp_output_26_0_g43376 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43376 = _Detail_BlendHardnessMask;
				float saferPower2_g43376 = abs( max( saturate( (0.0 + (temp_output_15_0_g43376 - ( 1.0 - temp_output_26_0_g43376 )) * (temp_output_24_0_g43376 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43376 ))) ) , 0.0 ) );
				float temp_output_22_0_g43376 = _Detail_BlendFalloffMask;
				float temp_output_403_0_g43375 = saturate( pow( saferPower2_g43376 , ( 1.0 - temp_output_22_0_g43376 ) ) );
				float4 lerpResult225_g43375 = lerp( Albedo_RGBA40_g43375 , ALBEDO_OUT255_g43375 , temp_output_403_0_g43375);
				float4 m_Active226_g43375 = lerpResult225_g43375;
				float saferPower11_g43376 = abs( max( saturate( (1.0 + (temp_output_15_0_g43376 - temp_output_26_0_g43376) * (( 1.0 - temp_output_24_0_g43376 ) - 1.0) / (0.0 - temp_output_26_0_g43376)) ) , 0.0 ) );
				float temp_output_403_21_g43375 = saturate( pow( saferPower11_g43376 , temp_output_22_0_g43376 ) );
				float4 lerpResult408_g43375 = lerp( ALBEDO_OUT255_g43375 , Albedo_RGBA40_g43375 , temp_output_403_21_g43375);
				float4 m_ActiveInverted226_g43375 = lerpResult408_g43375;
				float4 localDetail_Maskfloat4switch226_g43375 = Detail_Maskfloat4switch226_g43375( m_switch226_g43375 , m_Off226_g43375 , m_Active226_g43375 , m_ActiveInverted226_g43375 );
				float4 Mask_Albedo258_g43375 = localDetail_Maskfloat4switch226_g43375;
				float4 break48_g43375 = temp_output_39_0_g43375;
				float Albedo_RGB300_g43375 = ( break48_g43375.x + break48_g43375.y + break48_g43375.z );
				int m_switch319_g43375 = _BlendColor;
				float m_Red319_g43375 = IN.ase_color.r;
				float m_Green319_g43375 = IN.ase_color.g;
				float m_Blue319_g43375 = IN.ase_color.b;
				float localDetail_BlendVCfloatswitch319_g43375 = Detail_BlendVCfloatswitch319_g43375( m_switch319_g43375 , m_Red319_g43375 , m_Green319_g43375 , m_Blue319_g43375 );
				float clampResult47_g43375 = clamp( ( ( ( ( Albedo_RGB300_g43375 - 0.5 ) * ( _DetailBlendInfluence - 0.9 ) ) + ( localDetail_BlendVCfloatswitch319_g43375 - ( _BlendHeight - 0.4 ) ) ) / _DetailBlendSmooth ) , 0.0 , 1.0 );
				float DetailBlend43_g43375 = clampResult47_g43375;
				float4 lerpResult58_g43375 = lerp( Mask_Albedo258_g43375 , Albedo_RGBA40_g43375 , DetailBlend43_g43375);
				float4 lerpResult409_g43375 = lerp( Albedo_RGBA40_g43375 , lerpResult58_g43375 , _EnableDetailMap);
				...
				float3 temp_output_38_0_g43375 = ( temp_output_1478_59_g38532 + ADDITIONAL_LIGHT1342_g38532 );
				float3 Normal_XYZ260_g43375 = temp_output_38_0_g43375;
				float EnableDetailMask216_g43375 = _EnableDetailMask;
				float m_switch221_g43375 = EnableDetailMask216_g43375;
				float4 temp_output_1_0_g43378 = SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_trilinear_repeat, texCoord67_g43375 );
				float temp_output_8_0_g43378 = _DetailNormalMapScale;
				float3 unpack52_g43378 = UnpackNormalScale( temp_output_1_0_g43378, temp_output_8_0_g43378 );
				unpack52_g43378.z = lerp( 1, unpack52_g43378.z, saturate(temp_output_8_0_g43378) );
				float3 Detail_Normal199_g43375 = unpack52_g43378;
				float3 m_Off221_g43375 = Detail_Normal199_g43375;
				float3 lerpResult205_g43375 = lerp( Normal_XYZ260_g43375 , Detail_Normal199_g43375 , temp_output_403_0_g43375);
				float3 m_Active221_g43375 = saturate( lerpResult205_g43375 );
				float3 lerpResult406_g43375 = lerp( Detail_Normal199_g43375 , Normal_XYZ260_g43375 , temp_output_403_21_g43375);
				float3 m_ActiveInverted221_g43375 = saturate( lerpResult406_g43375 );
				float3 localDetail_Maskfloat3switch221_g43375 = Detail_Maskfloat3switch221_g43375( m_switch221_g43375 , m_Off221_g43375 , m_Active221_g43375 , m_ActiveInverted221_g43375 );
				float3 Mask_Normal222_g43375 = localDetail_Maskfloat3switch221_g43375;
				float layeredBlendVar413_g43375 = DetailBlend43_g43375;
				float3 layeredBlend413_g43375 = ( lerp( Mask_Normal222_g43375,Normal_XYZ260_g43375 , layeredBlendVar413_g43375 ) );
				float3 normalizeResult414_g43375 = normalize( layeredBlend413_g43375 );
				float3 temp_output_416_0_g43375 = BlendNormal( normalizeResult414_g43375 , Normal_XYZ260_g43375 );
				float EnebleMode122_g43375 = _EnableDetailMap;
				float3 lerpResult410_g43375 = lerp( Normal_XYZ260_g43375 , temp_output_416_0_g43375 , EnebleMode122_g43375);
				...
				float3 Albedo = lerpResult409_g43375.xyz;
				float3 Normal = lerpResult410_g43375;
				float3 Emission = 0;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult132_g43375 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43375 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43375 = IN.ase_texcoord2.xy * appendResult132_g43375 + appendResult114_g43375;
				float4 tex2DNode45_g43375 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat, texCoord67_g43375 );
				float4 ALBEDO_OUT255_g43375 = ( _ColorDetail * tex2DNode45_g43375 * _Brightness );
				float4 m_Off226_g43375 = ALBEDO_OUT255_g43375;
				float2 appendResult219_g43375 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43375 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43375 = IN.ase_texcoord2.xy * appendResult219_g43375 + appendResult206_g43375;
				float temp_output_15_0_g43376 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat, texCoord220_g43375 ).r );
				float temp_output_26_0_g43376 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43376 = _Detail_BlendHardnessMask;
				float saferPower2_g43376 = abs( max( saturate( (0.0 + (temp_output_15_0_g43376 - ( 1.0 - temp_output_26_0_g43376 )) * (temp_output_24_0_g43376 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43376 ))) ) , 0.0 ) );
...
/*ASEBEGIN
Version=18934
71;29.5;1654.5;850.5;-357.3817;1035.036;1;True;True
Node;AmplifyShaderEditor.FunctionNode;387;641.3608,-686.3875;Inherit;False;DESF Module Wind;91;;3439;b135a554f7e4d0b41bba02c61b34ae74;10,938,0,2881,0,2371,0,2454,0,2433,0,2434,0,2432,0,2457,0,2878,0,2752,0;0;1;FLOAT3;2190
Node;AmplifyShaderEditor.FunctionNode;392;859.2145,-686.399;Inherit;False;DESF Core Surface;9;;38532;c3df20d62907cd04086a1eacc41e29d1;18,183,2,1352,2,1382,1,1433,1,1432,1,1434,1,1638,0,1588,0,1491,0,1446,0,1284,0,249,0,1319,0,1318,0,1407,0,1443,0,1337,0,1336,0;1;309;FLOAT3;0,0,0;False;7;FLOAT3;42;FLOAT3;39;FLOAT;0;FLOAT4;41;COLOR;43;FLOAT;55;FLOAT3;313
...
Node;AmplifyShaderEditor.CommentaryNode;398;1381.197,-1054.591;Inherit;False;328.6918;357.9233;GLOBAL SETTINGS ;2;406;407;;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;391;1386.371,-342.9673;Inherit;False;DESF Utility ASE Compile Shaders;-1;;43374;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;389;1153.694,-680.6375;Inherit;False;DESF Module Detail;65;;43375;49c077198be2bdb409ab6ad879c0ca28;4,200,1,201,1,346,0,347,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
...
Node;AmplifyShaderEditor.IntNode;407;1401.882,-1015.036;Inherit;False;Property;_RenderFace;Render Face;3;2;[Header];[Enum];Create;False;1;SURFACE OPTIONS;0;1;Front,2,Back,1,Both,0;True;0;False;2;1;False;0;1;INT;0
...
Node;AmplifyShaderEditor.FunctionNode;406;1401.382,-936.7861;Inherit;False;DESF GUI URP Surface 10x;4;;43373;06c8ac62791f7a845bbafd8ecdb1912b;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=23B06E272D003ACB0F884F155A92ABE6066E3F3F